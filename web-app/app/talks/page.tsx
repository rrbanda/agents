    ...
    <div className="h-screen flex flex-col bg-[#0a0a0f] overflow-hidden">
      ...
      <div className="flex-1 flex max-w-7xl mx-auto w-full px-4 md:px-8 gap-6 pb-6 min-h-0">
        ...
        <aside className="hidden lg:flex flex-col w-64 flex-shrink-0">
          ...
          >
            <div className="p-5 flex-1 overflow-y-auto talks-scroll">
              {/* Category Section */}
              <div className="mb-6">
        ...
        <main className="flex-1 min-w-0 flex flex-col min-h-0">
          ...
          <motion.div
            ...
            className="lg:hidden flex-shrink-0 mb-4 overflow-x-auto talks-scroll pb-2"
          >
          ...
          {/* Scrollable Talks List */}
          <div className="flex-1 overflow-y-auto talks-scroll pr-2 min-h-0">
...
function TalkCard({ talk }: { talk: typeof talks[0] }) {
  ...
  return (
    <motion.div
      whileHover={isAvailable ? { scale: 1.005, x: 2 } : {}}
    ...
    >
      ...
      <div className="relative p-4 flex items-center gap-4">
        {/* Level Badge */}
        <div className={`flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center font-bold text-sm ${levelColors[talk.level]}`}>
          {talk.level}
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-0.5">
            ...
            {talk.featured && isAvailable && (
              <span className="px-1.5 py-0.5 rounded bg-cyan-500/20 text-cyan-400 text-[9px] font-medium">
                Featured
              </span>
            )}
            {!isAvailable && (
        ...
        <div className="hidden sm:flex items-center gap-4 flex-shrink-0">
          ...
          {isAvailable && (
            <motion.div
              className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-500 group-hover:bg-cyan-500/20 group-hover:text-cyan-400 transition-all"
            >
