...
export default function LimitationsSlide() {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
            ...
            <div className="p-5">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-red-400 text-sm">⚠️ Limitation:</span>
                </div>
                <p className="text-gray-300 text-sm pl-6">{item.description}</p>
              </div>
              ...
              >
                ...
                <p className="text-gray-300 text-sm pl-5">{item.solution}</p>
              </motion.div>
            </div>
          </motion.div>
        ))}
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-amber-900/30 to-orange-900/30 rounded-xl p-6 border border-amber-500/30 max-w-2xl"
      >
